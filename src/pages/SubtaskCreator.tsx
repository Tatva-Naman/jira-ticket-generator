...
import AddStory from "../components/SubTask/AddStory";
import StoryList from "../components/SubTask/StoryList";
import PreviewList from "../components/SubTask/PreviewList";
...
export default function SubtaskCreator() {
  ...
  return (
    <div className="min-h-screen bg-[#0A1628] text-white">
      <span className="font-semibold text-4xl block mb-6">Subtasks</span>
